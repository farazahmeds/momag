...
class GUIWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.run_motion_magnification.setGeometry(QtCore.QRect(1020, 530, 161, 51))
        self.run_motion_magnification.setObjectName("run_motion_magnification")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(870, 530, 31, 40))
        self.label_3.setObjectName("label_3")
        self.lineEdit_alpha = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_alpha.setGeometry(QtCore.QRect(910, 540, 61, 20))
        self.lineEdit_alpha.setObjectName("lineEdit_alpha")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(870, 620, 91, 40))
        self.label_4.setObjectName("label_4")
        self.lineEdit_frame_rate = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_frame_rate.setGeometry(QtCore.QRect(960, 630, 61, 20))
        self.lineEdit_frame_rate.setObjectName("lineEdit_frame_rate")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(940, 470, 111, 20))
        self.label_5.setObjectName("label_5")
        self.label_total_frames = QtWidgets.QLabel(self.centralwidget)
        self.label_total_frames.setGeometry(QtCore.QRect(1050, 470, 121, 21))
        ...
        self.lineEdit_file_name.setGeometry(QtCore.QRect(930, 660, 161, 20))
        self.lineEdit_file_name.setObjectName("lineEdit_file_name")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(870, 650, 51, 40))
        self.label_6.setObjectName("label_6")
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setGeometry(QtCore.QRect(840, 480, 20, 211))
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(870, 500, 111, 20))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(870, 560, 51, 40))
        self.label_8.setObjectName("label_8")
        self.lineEdit_threshold = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_threshold.setGeometry(QtCore.QRect(930, 570, 61, 20))
        self.lineEdit_threshold.setObjectName("lineEdit_threshold")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(500, 590, 271, 31))
        self.label_9.setTextFormat(QtCore.Qt.RichText)
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(500, 620, 291, 10))
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(500, 480, 51, 20))
        self.label_11.setObjectName("label_11")
        self.label_segments = QtWidgets.QLabel(self.centralwidget)
        self.label_segments.setGeometry(QtCore.QRect(560, 480, 51, 21))
        ...
        self.lineEdit_frame_sampling_rate.setGeometry(QtCore.QRect(930, 600, 61, 20))
        ...
        self.label_12.setGeometry(QtCore.QRect(870, 590, 51, 41))
        self.label_12.setObjectName("label_12")
        self.label_timestamp = QtWidgets.QLabel(self.centralwidget)
        self.label_timestamp.setGeometry(QtCore.QRect(670, 480, 151, 21))
        self.label_timestamp.setText("")
        self.label_timestamp.setObjectName("label_timestamp")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1651, 21))
